...
# Tokenizer
VOCAB_SIZE = 10000        # Byte-level BPE 10K — carried forward from T1d as best tokenizer
...
# Paths
DATA_FILE = "gen/qa_pairs_augmented.txt"  # EDA-augmented Q&A corpus (run make augment first)
CHECKPOINT_DIR = "gen"
